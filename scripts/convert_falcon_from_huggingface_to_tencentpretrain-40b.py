...
for i in range(args.layers_num):
    ...
    output_model["encoder.transformer." + str(i) + ".layer_norm_1.weight"] = \
        get_weight_from_name("transformer.h." + str(i) + ".ln_attn.weight")
    output_model["encoder.transformer." + str(i) + ".layer_norm_1.bias"] = \
        get_weight_from_name("transformer.h." + str(i) + ".ln_attn.bias")

    output_model["encoder.transformer." + str(i) + ".layer_norm_2.weight"] = \
        get_weight_from_name("transformer.h." + str(i) + ".ln_mlp.weight")
    output_model["encoder.transformer." + str(i) + ".layer_norm_2.bias"] = \
        get_weight_from_name("transformer.h." + str(i) + ".ln_mlp.bias")
