...
if __name__ == '__main__':
    ...
    with open(args.prediction_path, 'w') as fw:
        lines = ["Last summer, Cathy's family went to New York City for their summer vacation.",
                 "Disneyland in Shanghai Built from 2011, Shanghai Disney Resort is the sixth Disneyland park in the world,",
                "There is  a nice girl in our class. She is twelve.",
                "Life in the year 3044 is very different from life in the 21st century ."]
        ...
        for l in lines:
            ...
            src = args.tokenizer.convert_tokens_to_ids(args.tokenizer.tokenize(l))
            seg = [1] * len(src)
