...
ext_model = spm.SentencePieceProcessor()
ext_model.Load('models/llama_char_ext.model')
...
input_padding = torch.rand(8076, 4096)
output_padding = torch.rand(8076, 4096)
...
torch.save(input_model, 'models/llama2-7b-char-ext.bin')
