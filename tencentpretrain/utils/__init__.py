...
str2tokenizer = {"char": CharTokenizer, "space": SpaceTokenizer, "bert": BertTokenizer,
                 ...
                 "text_image": TextImageTokenizer, "virtual": VirtualTokenizer, "chatglm": ChatGLMTokenizer}
str2dataset = {"bert": BertDataset, "lm": LmDataset, "mlm": MlmDataset,
               ...
               "beit":BeitDataset, "dalle": DalleDataset, "chatglm": ChatGLMDataset}
str2dataloader = {"bert": BertDataloader, "lm": LmDataloader, "mlm": MlmDataloader,
                  ...
                  "beit":BeitDataloader, "dalle": DalleDataloader, "chatglm": ChatGLMDataloader}
